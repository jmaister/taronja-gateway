...
func RegisterProviders(mux *http.ServeMux, sessionStore session.SessionStore, gatewayConfig *config.GatewayConfig, userRepo db.UserRepository) {
	...
	registerLogout(mux, sessionStore, gatewayConfig.Management.Prefix)
...
func registerLogout(mux *http.ServeMux, sessionStore session.SessionStore, managementPrefix string) {
